...
# Title: Top Block
# Generated: Thu Oct  6 21:49:45 2016
##################################################
...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(1, firdes.low_pass(
        	1, 1.6e6, 300e3, 10e3, firdes.WIN_HAMMING, 6.76))
        ...
        self.digital_costas_loop_cc_0 = digital.costas_loop_cc(freq_bw, 8, False)
        self.digital_cma_equalizer_cc_0 = digital.cma_equalizer_cc(4, 1, 100E-6, 1)
